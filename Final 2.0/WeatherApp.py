...
def filewrite():
    ...
    message = f"Subject: Subscription mail\n\nThank You for Subscribing to Our Service"
    server.sendmail('focpproject@gmail.com',NewEntry,message)
    server.quit()
...
if ForecastedWeather in ['Mist','Smoke','Haze','Dust','Fog']:
    WeatherCanvas.create_text(285,280,text='Foggy',font=WeatherFont2,fill="Black")
    WeatherCanvas.create_text(380,330,text="WindSpeed: "+str(Wind)+" kph  |"+"  Feels like "+str(FeelsLike)+"°C",font=8)
    logo1=gui.PhotoImage(file="icon3.png")
    WeatherCanvas.create_image(95,245,image=logo1)
#Putting Text
